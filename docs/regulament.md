...
### 1.3 Condiții pentru a putea juca pe server
...
<span id="2.4">### 2.4 Revenge Kill (RK)</span>
...
Cât timp ați fost în comă nu știți ce s-a întâmplat în jur, altfel se va considera și se va sancționa conform regulii [#2.10 MetaGaming (MG)](#2.10)

## 2.6.1 Apelul către medici
...
<span style="color: red">Sancțiuni pentru apel către medici din zone interzise: </span>
prima abatare: 50-100 Checkpoint-uri 
a doua abatere: 200 Checkpoint-uri
trei sau mai multe abateri: warn
...
## <a id="2.10"></a>2.10 MetaGaming (MG)
...
Exemplu: Un jucător se află în fața unui magazin fără mașină și caută un alt jucător pe chatul din joc solicitându-i să vină să-l ia de acolo.
Sancțiuni:
